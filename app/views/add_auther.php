...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">Name_Auther</label>
      ...
      <div class="col-md-6">
        ...
        <div class="input-group input-group-merge">
          <input  name="bio"type="number" id="multicol-email" class="" placeholder="" aria-label="" aria-describedby="multicol-email2" />
          <span class="" id="multicol-email2"></span>
        </div>
      </div>
