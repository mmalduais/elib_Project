...
<svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
  ...
  <ul class="menu-inner py-1">
      ...
      <ul class="menu-sub">
        ...
        <li class="menu-item">
          <a href="forms-input-groups.html" class="menu-link">
            <div >ADD  Book<div>
              <button type="button" name="" id="" class="btn btn-primary|secondary|success|danger|warning|info|light|dark|link"></button>
            </div></div>
          </a>
        </li>
        <li class="menu-item">
    ...
    <li class="menu-item active open">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons bx bx-detail"></i>
        <div data-i18n="Form Layouts">ADD User</div>
      </a>
      <ul class="menu-sub">
...
<div class="card mb-4">
  ...
  <form class="card-body" action="/save_user" method="POST">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">NAme CAtegory</label>
        <input name="title" type="text" id="multicol-username" class="form-control" placeholder="NAme .CAtegory" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">Image For Category</label>
        <div class="input-group input-group-merge">
          ...
          <span class="input-group-text" id="multicol-email2">image.category</span>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-password-toggle">
          <label class="form-label" for="multicol-confirm-password">Category activation</label>
          <div class="input-group input-group-merge">
          <label class="switch">
